  ...
  <div>
    ...
    <b-table striped hover :items="items" :fields="fields">
      ...
      <template #cell(price)="data">
          <b-form-input v-if="selectedRow[data.index]" type="number" v-model="items[data.index].price"></b-form-input>
          <span v-else>{{data.value}}</span>
      </template>
      <template #cell(stock)="data">
          <b-form-input v-if="selectedRow[data.index]" type="number" v-model="items[data.index].stock"></b-form-input>
          <span v-else>{{data.value}}</span>
      </template>
      <template #cell(image_url)="data">
          <b-form-input v-if="selectedRow[data.index]" type="url" v-model="items[data.index].image_url"></b-form-input>
          <span v-else>{{data.value}}</span>
      </template>
